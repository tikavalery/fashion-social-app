...
function Login() {
  return (
    <div>
      <div className="d-flex justify-content-between py-sm-3 bg-white border-bottom mb-5 py-2 pl-2 px-sm-0 px-sm-4 pr-4 pr-sm-0">
			<img className="log" src="./main-logo-2.png" alt="" />
        <ul className="nav nav-pills nav-justified d-flex align-items-center" id="ex1" role="tablist">
  ...
  <div className="tab-content">
    <div className="tab-pane fade show active mt-5 pt-5" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
        ...
        <p className="second-option">New here? <a href="#" className="text-success">Create an account</a></p>
      <form>
        ...
        <button type="submit" className="btn btn-success btn-block mb-3 py-2">Sign in</button>
